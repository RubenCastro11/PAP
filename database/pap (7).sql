...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Jul-2021 às 22:38
...
(6, 1, 7, 1, 'FZ', '800', '23500', 6000, 'Azul', '2010-06-16', 'Revisão feita. Pneus em muito bom estado. Frente tem pouco mais de 1000kms. Manetes curtas. Banco condutor em gel. Suporte telemóvel com ficha de carregamento. Ponteira réplica Akrapovic', '1625774753_FZ8.jpg', '2021-02-26 16:27:24', '2021-07-08 19:05:53', NULL),
...
(1, 4, 'Mota com 300 de cilindrada a 2 tempos do ano de 2019 com poucos quilometros. Mota impecavel para enduro e para motocross sem problemas e com a revisao feita', '1616169381_ktm-removebg-preview.png', NULL, '2021-03-19 15:56:21', NULL),
(2, 4, 'Honda CB600 F  e cerca de 28990 km, praticamente nova', '1625773845_hornet.webp', '2021-03-01 17:32:59', '2021-07-08 18:50:45', NULL);
...
--
ALTER TABLE `motas`
  MODIFY `id_mota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
